...
const mnemonic = "minor level chase mansion exotic turtle laugh clown father below alien sauce";
...
module.exports = {
  ...
  networks: {
    polygontestnet: {
     provider: () => new HDWalletProvider(mnemonic, `https://polygon-mumbai.infura.io/v3/798a2c084da64a6f866cc1695374a349`),
